...
Build the OpenCV4 (>=4.2.0):this project use 4.2.0 version
...
## 3. Run FLOW-VIO with EuRoC, TUM-VI, 4Seasons，Odin1 and Our dataset
...
```bash
source ~/catkin_ws/devel/setup.bash
rosrun flow_vio flow_vio_node src/FLOW-VIO/yaml/SETTING.yaml YOUR_BAG_FOLDER/BAG_NAME.bag trajectory.tum
```
